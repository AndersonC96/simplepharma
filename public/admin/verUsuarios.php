...
// Fetch users
$query = "SELECT id, name, email, role, active, created_at FROM users WHERE name LIKE :search_name OR email LIKE :search_email ORDER BY $order_by LIMIT :limit OFFSET :offset";
