project/
|--admin/
|	|--abrirchamadoAdmin.php | Página para abrir chamado • Feito
|	|--adminHome.php | Página inicial do administrador • Feito
|	|--chamadosAbertos.php | Página para ver chamados abertos • Feito
|	|--chamamadosConcluidos.php | Página para ver chamados concluídos • 
...
|	|--deleteTec.php | Página para deletar técnicos • 
|	|--deleteTec2.php | Página para deletar técnicos • 
...
|--autenticacaoUsuario.php | Página para autenticar usuário • Feito
