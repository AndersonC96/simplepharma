            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php } ?>
                        <td class="text-center"><a class="btn btn-info btn-sm" href="fazerchamadoTec.php?chamado=<?php echo $produto['contador']; ?>" data-bs-toggle="tooltip" title="Fazer Chamado"><span class="glyphicon glyphicon-edit"></span>Fazer</td>
                    </tr>
                    ...
                    <?php
                        for($i = 0; $i < $num_paginas; $i++){
                            ...
                            if($pagina == $i)
                                $estilo = "class=\"active\"";
                    ?>
                    <li <?php echo $estilo; ?>><a class="page-link" href="chamadosabertosTec.php?pagina=<?php echo $i; ?>"><?php echo $i + 1; ?></a></li>
                    <?php } ?>
                    <li class="page-item">
