...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-4">
            <h3 class="text-center">Seus chamados em aberto</h3>
            <div class="table-responsive">
                <table class="table table-custom">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-info btn-sm" href="fazerchamadoTec.php?chamado=<?php echo $produto['contador']; ?>" data-bs-toggle="tooltip" title="Fazer Chamado"><i class="bi bi-pencil"></i> Fazer</a>
                            </td>
                        </tr>
                ...
                <nav>
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="chamadosabertosTec.php?pagina=0" aria-label="Previous">
                        ...
                        ?>
                        <li class="page-item <?php echo $estilo; ?>"><a class="page-link" href="chamadosabertosTec.php?pagina=<?php echo $i; ?>"><?php echo $i + 1; ?></a></li>
                        <?php } ?>
                        <li class="page-item">
                            <a class="page-link" href="chamadosabertosTec.php?pagina=<?php echo $num_paginas - 1; ?>" aria-label="Next">
