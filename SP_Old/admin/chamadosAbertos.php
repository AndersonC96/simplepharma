            ...
            <table class="table table-striped table-bordered">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><b>Local</b></th>
                        <th class="text-center"><b>Técnico</b></th>
                        <th class="text-center"><b>Abertura</b></th>
                        <th class="text-center"><b>Status</b></th>
                        <th class="text-center"><b>Detalhes</b></th>
                    </tr>
                </thead>
                <tbody>
                    <?php do{ ?>
                    <tr>
                        ...
                        <?php if ($produto['status'] == "Aberto") { ?>
                            <td  class="text-center" style="background-color: #F00;"><?php echo $produto['status']; ?></td>
                        <?php } elseif ($produto['status'] == "Feito") { ?>
                            <td  class="text-center" style="background-color: #0F0;"><?php echo $produto['status']; ?></td>
                        <?php } ?>
                        <td class="text-center">
                            <a class="btn btn-info btn-sm" href="ver1chamadoAdmin.php?chamado=<?php echo $produto['contador']; ?>" data-toggle="tooltip" title="Detalhes">
                                <span class="glyphicon glyphicon-share"></span>Ver
                            </a>
                        </td>
                    </tr>
