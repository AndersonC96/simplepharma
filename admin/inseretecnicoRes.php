    ...
    <body>
        ...
        <div class="container">
            ...
            <form method="POST" action="processacadTecnic.php">
                <div class="mb-3">
                    <label for="nomecomptec" class="form-label"><b>Nome Completo</b></label>
                    <input type="text" class="form-control" id="nomecomptec" name="nomecomptec" placeholder="Nome do técnico" required>
                </div>
                <div class="mb-3">
                    <label for="nomesistec" class="form-label"><b>Nome de usuário</b></label>
                    <input type="text" class="form-control" id="nomesistec" name="nomesistec" placeholder="Nome de usuário" required>
                </div>
                <div class="mb-3">
                    <label for="senhatec" class="form-label"><b>Senha</b></label>
                    <input type="password" class="form-control" id="senhatec" name="senhatec" placeholder="Senha para o técnico" required>
                </div>
                <button type="submit" class="btn btn-success"><i class="fas fa-user-plus"></i> Inserir Técnico</button>
            </form>
        </div>
    </body>
</html>