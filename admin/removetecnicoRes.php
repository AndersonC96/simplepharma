...
<html lang="en">
    <head>
        <title><?php echo $_SESSION['sess_usersisname']; ?> | Remover Técnico</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <br>
        <div class="container">
            <h2>Digite o nome de usuário do técnico a ser removido</h2>
            <form method="POST" action="deleteTec.php">
                <div class="mb-3">
                    <label for="tecex" class="form-label"><b>Nome</b></label>
                    <input type="text" class="form-control" id="tecex" name="tecex" placeholder="Nome de usuário do técnico a ser removido" required>
                </div>
                <button type="submit" class="btn btn-danger"><i class="fas fa-user-minus"></i> Remover Técnico</button>
            </form>
        </div>
    </body>
</html>