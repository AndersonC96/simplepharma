	...
	<body>
		...
		<div class="container">
			...
			<nav>
				<ul class="pagination">
					<li>
						<a href="verTecnicos.php?pagina=0" aria-label="Previous">
					...
					<?php
						for($i=0;$i<$num_paginas;$i++){
							...
							if($pagina == $i)
								$estilo = "class=\"active\"";
					?>
					<li <?php echo $estilo; ?> ><a href="verTecnicos.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
					<?php } ?>
					<li>
						<a href="verTecnicos.php?pagina=<?php echo $num_paginas-1; ?>" aria-label="Next">
