...
<html lang="en">
    <head>
        <title><?php echo $_SESSION['sess_usersisname']; ?> | Remover Usuário</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <br>
        <div class="container">
            <h2>Informe o nome de usuário a ser removido</h2>
            <form method="POST" action="deleteUsr.php">
                <div class="mb-3">
                    <label for="tecex" class="form-label"><b>Nome</b></label>
                    <input type="text" class="form-control" id="tecex" placeholder="Nome de usuário a ser removido" name="tecex" required>
                </div>
                <button type="submit" class="btn btn-danger"><i class="fas fa-user-minus"></i> Remover Usuário</button>
            </form>
        </div>
    </body>
</html>