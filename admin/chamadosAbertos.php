<?php
    ...
    $sql_code = "SELECT contador, local, tecnico, datahora, status, servico FROM chamados WHERE status IN ('Aberto', 'Em Andamento') ORDER BY contador DESC LIMIT $item, $itens_por_pagina";
    $execute = $conn->query($sql_code) or die($conn->error);
    $produto = $execute->fetch_assoc();
    $num = $execute->num_rows;
    $num_total = $conn->query("SELECT contador, local, tecnico, datahora, status, servico FROM chamados WHERE status IN ('Aberto', 'Em Andamento')")->num_rows;
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge badge-status <?php echo ($produto['status'] == 'Aberto') ? 'status-aberto' : 'status-em-andamento'; ?>">
