        ...
        <div class="modal fade" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Usuário Inválido</div>
                    <div class="modal-footer">
                        <a class="btn btn-danger btn-lg" href="removeUsuario.php">Entendido</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="myModal2">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">Usuário removido com sucesso !</div>
                    <div class="modal-footer">
                        <a class="btn btn-sucess btn-lg" href="removeUsuario.php">Entendido</a>
                    </div>
                </div>
            </div>
        </div>
